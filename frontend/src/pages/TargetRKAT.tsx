...
"text-[8px] font-extrabold px-1.5 py-0.5 rounded-full",
 ...
 {act.asnaf ? (
 <span className="px-2.5 py-1 rounded bg-amber-50 text-amber-800 border border-amber-200/50 font-black text-[10px]">
 {act.asnaf}
 </span>
 ) : (
...
"h-full rounded-full transition-all duration-300",
 ...
 <span className="text-primary font-bold shrink-0">Target RKAT</span>
 </nav>
...
"pb-3 text-sm font-black transition-all border-b-2",
 ...
 <div>
 <p className="text-xs text-slate-400 font-bold">Total Anggaran Operasional</p>
 ...
 <div>
 <p className="text-xs text-slate-400 font-bold">Capai Realisasi Operasional</p>
 ...
 className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-4 py-2 rounded-xl flex items-center gap-1.5 text-xs font-black transition-all active:scale-95 shrink-0 border border-slate-200"
 >
 ...
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-12 text-center">No</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400">Program / Kegiatan</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-24 text-center">Volume</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-24 text-center">Frekuensi</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-32 text-right">Unit Cost</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-36 text-right">Nilai Anggaran</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-36 text-right">Realisasi</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-28 text-center">% Pencapaian</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-28 text-center">Aksi</th>
 </tr>
 </thead>
...
"hover:bg-slate-50/80 transition-colors cursor-pointer select-none",
 ...
 <div className="flex flex-col items-center justify-center gap-1">
 <span className={cn(
"px-2 py-0.5 rounded-full text-[10px] font-black font-sans",
...
"bg-amber-500"
 ...
 <span className="text-[10px] font-black text-slate-400 block border-b border-slate-100 pb-1">{getMonthName(idx + 1)}</span>
...
"text-slate-400"
 ...
 <td colSpan={5} className="px-4 py-4 text-xs font-black text-slate-800 text-right">
 ...
 <div>
 <p className="text-xs text-slate-400 font-bold">Total Anggaran Pengumpulan</p>
 ...
 <div>
 <p className="text-xs text-slate-400 font-bold">Capai Realisasi Pengumpulan</p>
 <div className="flex items-center gap-2 mt-1">
 ...
 className={cn(
"py-1 px-3 rounded-full text-[10px] md:text-xs font-bold transition-all focus:outline-none border cursor-pointer",
 ...
 <tr className="bg-slate-50 border-b border-slate-200">
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-12 text-center">No</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-24 text-center">Kategori</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400">Nama Program / Kegiatan</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-40 text-right">Target Anggaran</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-40 text-right">Realisasi</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-28 text-center">% Pencapaian</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-28 text-center">Aksi</th>
 </tr>
 </thead>
...
"text-slate-400"
 ...
 <td colSpan={3} className="px-4 py-4 text-xs font-black text-slate-800 text-right">
 ...
 <div>
 <p className="text-xs text-slate-400 font-bold">Total Anggaran RKAT</p>
 ...
 <div>
 <p className="text-xs text-slate-400 font-bold">Capai Realisasi Berjalan</p>
 <div className="flex items-center gap-2 mt-1">
 ...
 className={cn(
"py-2.5 px-4 text-[10px] md:text-xs font-black rounded-xl transition-all text-center focus:outline-none whitespace-nowrap",
...
"py-2.5 px-4 text-[10px] md:text-xs font-black rounded-xl transition-all text-center focus:outline-none whitespace-nowrap",
 ...
 <span className="text-[10px] font-extrabold bg-emerald-50 text-emerald-700 px-3 py-1 rounded-md border border-emerald-100">
 ...
 <th className="px-4 py-3 text-[10px] font-black text-slate-400 w-12 text-center">No</th>
 <th className="px-4 py-3 text-[10px] font-black text-slate-400 w-48">Kode &amp; Nama Akun Pilar</th>
 <th className="px-4 py-3 text-[10px] font-black text-slate-400 w-36 text-right">Anggaran Biaya</th>
 <th className="px-4 py-3 text-[10px] font-black text-slate-400 w-36 text-right">Realisasi</th>
 <th className="px-4 py-3 text-[10px] font-black text-slate-400 w-28 text-center">Prosentase</th>
 
 {/* Months */}
 {Array.from({ length: 12 }, (_, i) => i + 1).map(month => (
 <th key={month} className="px-3 py-3 text-[9px] font-black text-slate-400 text-right w-24 bg-slate-50/30">
 ...
 <td colSpan={2} className="px-4 py-4 text-xs font-black text-slate-800 text-right">
 ...
 <span className="px-3 py-1 bg-primary/10 text-primary font-black text-[10px] rounded-md">
 {selectedPilarFilter}
 </span>
 </div>
 ...
 <tr className="bg-slate-55 border-b border-slate-200">
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-12 text-center">No</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-60">Program / Kegiatan Kerja</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-24 text-center">Asnaf</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 w-36">Hubungan COA</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400">Keterangan Spesifikasi</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 text-right w-48">Target RKAT &amp; Rincian</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 text-right w-48">Realisasi Aktual &amp; Sisa</th>
 <th className="px-4 py-3.5 text-[10px] font-black text-slate-400 text-center w-24">Aksi</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-slate-100 text-xs">
 ...
 <>
 <tr>
 <td colSpan={8} className="px-4 py-2.5 text-xs font-black text-slate-700 bg-slate-100/60 border-y border-slate-200">
 ...
 <div>
 <h4 className="text-xs font-black text-emerald-800">Prinsip Akuntansi Syariah BAZNAS</h4>
 ...
 className="bg-white border border-emerald-200 hover:bg-emerald-50 text-emerald-700 px-4 py-2.5 rounded-xl flex items-center gap-2 text-xs font-black transition-all shadow-xs shrink-0"
 >
