                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                          ...
                          className="p-2 text-emerald-550 hover:bg-emerald-50 rounded-xl transition-all"
                          title="Setujui"
                        >
            ...
            >
              ...
              <div className="p-6 border-t border-slate-100 bg-slate-50 flex gap-3 shrink-0">
                <button
                  ...
                  className="w-full px-6 py-3 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2"
                >
                  <CheckCircle2 className="size-4" />
                  Setujui &amp; Teruskan
                </button>
