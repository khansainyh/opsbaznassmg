...
export default function SurveiObs({ data, onUpdate }: SurveiObsProps) {
 ...
 <div>
 <p className="text-white/80 text-[10px] font-black mb-1">Target Survei OBS</p>
 ...
 <h3 className="text-xs font-black text-slate-400 mb-4 border-b border-slate-50 pb-2">Lokasi Tujuan</h3>
 ...
 <div className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100">
 <h3 className="text-xs font-black text-slate-400 mb-4 border-b border-slate-50 pb-2">Hubungi Penanggung Jawab</h3>
 ...
 <p className="text-[10px] text-slate-500 font-bold">Telepon UPZ / Pengurus</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-xs font-black text-slate-400">Dokumen Proposal</h3>
 ...
 <span className="text-[10px] bg-emerald-50 text-emerald-700 border border-emerald-250 px-2 py-0.5 rounded font-black">
 OBS
 </span>
 </div>
 </div>
 ...
 <h4 className="text-xs font-black text-slate-500 border-b pb-2">Informasi UPZ Masjid/Musholla</h4>
 
 <div className="space-y-3">
 <div>
 <label className="text-[10px] font-bold text-slate-400 block mb-1">Nama UPZ</label>
 <input
 type="text"
 readOnly
 ...
 <div>
 <label className="text-[10px] font-bold text-slate-400 block mb-1">Nama Ketua UPZ / Takmir</label>
 <input
 type="text"
 required
 ...
 <div>
 <label className="text-[10px] font-bold text-slate-400 block mb-1">No. WA Ketua</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-[10px] font-bold text-slate-400 block mb-1">Alamat Masjid</label>
 <textarea
 rows={2}
 ...
 <div>
 <label className="text-[10px] font-bold text-slate-400 block mb-1">Kecamatan</label>
 <input
 type="text"
 readOnly
 ...
 <label className="text-[10px] font-bold text-emerald-700 block mb-1">Saldo Awal Periode (Keseluruhan)</label>
 ...
 <h4 className="text-xs font-black text-slate-800">A. Laporan Penerimaan (Jan - Juni)</h4>
 </div>
 ...
 <label className="text-[9px] font-bold text-slate-400">Penerimaan (Rp)</label>
 <div className="relative flex items-center">
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Donatur (Orang)</label>
 <input
 type="number"
 placeholder="0"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Keterangan</label>
 <input
 type="text"
 ...
 <label className="text-[9px] font-bold text-emerald-600">Beras (kg)</label>
 <input
 type="number"
 min="0"
 step="0.1"
 ...
 <span className="text-[9px] font-black text-slate-500">Item #{idx + 1}</span>
 <button
 type="button"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Jenis Barang/Jasa</label>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Merek / Spesifikasi</label>
 <input
 type="text"
 ...
 <div className="grid grid-cols-2 gap-2">
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Jumlah</label>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-emerald-600">Kambing/Domba (ekor)</label>
 <input
 type="number"
 min="0"
 step="1"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-emerald-600">Sapi/Kerbau (ekor)</label>
 <input
 type="number"
 min="0"
 step="1"
 ...
 <div className="space-y-4">
 <div className="flex items-center justify-between border-b pb-2 border-slate-200">
 <h4 className="text-xs font-black text-slate-800">B. Laporan Penyaluran (Jan - Juni)</h4>
 </div>
 ...
 <div className="grid grid-cols-2 gap-2.5">
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Jumlah Penyaluran</label>
 <div className="relative flex items-center">
 <span className="absolute left-2.5 text-[10px] font-extrabold text-slate-400">Rp</span>
 <input
 type="text"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-slate-400">Mustahik (Orang)</label>
 <input
 type="number"
 placeholder="0"
 ...
 <div className="space-y-1 border-t border-slate-50 pt-2">
 <label className="text-[9px] font-bold text-rose-500">Beras (kg)</label>
 <input
 type="number"
 min="0"
 step="0.1"
 ...
 <div className="grid grid-cols-2 gap-2.5 border-t border-slate-50 pt-2">
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-rose-500">Kambing/Domba (ekor)</label>
 <input
 type="number"
 min="0"
 step="1"
 ...
 <div className="space-y-1">
 <label className="text-[9px] font-bold text-rose-500">Sapi/Kerbau (ekor)</label>
 <input
 type="number"
 min="0"
 step="1"
 ...
 <h4 className="text-xs font-black text-primary border-b border-primary/10 pb-2">C. Saldo Akhir Laporan</h4>
 <div className="flex items-center justify-between">
...
"w-full text-xs font-semibold pl-3 pr-7 py-2.5 rounded-xl border outline-none appearance-none cursor-pointer transition-all",
 ...
 <div className="px-3 py-1 bg-slate-100 text-slate-600 text-[10px] font-black rounded-full">
 UPZ MASJID
 </div>
 ...
 <p className="text-[9px] font-black mb-1 opacity-60 text-slate-400">Ringkasan Keuangan</p>
...
"px-3 py-1 rounded-full text-[10px] font-black border",
 ...
 <p className="text-[9px] font-black text-slate-400 mb-1.5">Program & Jenis</p>
 ...
 <span className="text-[9px] font-black">Riwayat</span>
