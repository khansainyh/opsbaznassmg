  ...
  useEffect(() => {
    if (isAuthenticated && user) {
      ...
      const allItems = [
        ...
        { name: "Off-Balancing", roles: ["Super_Admin", "Kabag_Pelaporan", "Staf_Pelaporan", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan"], requiresObs: true },
        { name: "Pelaporan OBS", roles: ["Super_Admin", "Relawan", "Relawan_Sementara", "Tim_Monev", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan", "Kabag_Pelaporan", "Staf_Pelaporan"], requiresObs: true },
        { name: "Antrean SIMBA", roles: ["Super_Admin", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan"] },
        { name: "Realisasi Bantuan", roles: ["Super_Admin", "Wakil_Ketua_II", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan"] },
        { name: "Antrean Arsip", roles: ["Super_Admin", "Wakil_Ketua_II", "Staf_Pendistribusian", "Staf_Pendayagunaan"] },
        ...
        { name: "Antrean Pencairan", roles: ["Super_Admin", "Staf_Keuangan", "Kabag_Keuangan"] },
