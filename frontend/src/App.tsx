  ...
  useEffect(() => {
    if (isAuthenticated && user && obsParamLoaded) {
      ...
      const allItems = [
        ...
        { name: "Program & Kegiatan", roles: ["Super_Admin", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan"] },
        { name: "Database UPZ", roles: ["Super_Admin", "Staf_Administrasi", "Kabag_Pengumpulan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Staf_Pengumpulan", "Staf_Pelaporan", "Kabag_Pelaporan", "Staf_Keuangan", "Kabag_Keuangan"] },
        ...
        { name: "Off-Balancing", roles: ["Super_Admin", "Kabag_Pelaporan", "Staf_Pelaporan", "Kabag_Pendistribusian"], requiresObs: true },
        { name: "Pelaporan OBS", roles: ["Super_Admin", "Relawan", "Relawan_Sementara", "Tim_Monev", "Kabag_Pendistribusian", "Kabag_Pelaporan", "Staf_Pelaporan"], requiresObs: true },
        ...
        { name: "Antrean SIMBA", roles: ["Super_Admin", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan"] },
        { name: "Antrean Arsip", roles: ["Super_Admin", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Kabag_Pendistribusian", "Kabag_Pendayagunaan", "Staf_Pelaporan"] },
        ...
        { name: "Simulator Pencairan", roles: ["Super_Admin", "Staf_Keuangan", "Kabag_Keuangan", "Kepala_Pelaksana"] },
        ...
        { name: "Jurnal Buku Besar", roles: ["Super_Admin", "Kabag_Pelaporan", "Staf_Pelaporan", "Kabag_Keuangan", "Staf_Keuangan"] },
        { name: "Rekonsiliasi Mutasi", roles: ["Super_Admin", "Kabag_Pelaporan", "Staf_Pelaporan"] },
        { name: "Parameter Sistem", roles: ["Super_Admin", "Kabag_Pelaporan", "Staf_Pelaporan"] },
        ...
        { name: "Ganti Password", roles: [
          ...
          "Kepala_Pelaksana", "Staf_Administrasi", "Staf_Pendistribusian", "Staf_Pendayagunaan", "Staf_Keuangan", "Kabag_Keuangan", "Staf_Pengumpulan",
          ...
          .then(res => {
            const mappedData = res.data.map((item: any) => {
              ...
              return {
                ...
                nik: item.nik || '',
                no_kk: item.no_kk || item.mustahik?.no_kk || '',
                jenis_kelamin: item.jenis_kelamin || item.mustahik?.jenis_kelamin || '',
                tempat_lahir: item.tempat_lahir || item.mustahik?.tempat_lahir || '',
                tanggal_lahir: item.tanggal_lahir || item.mustahik?.tanggal_lahir || '',
                ttl: item.ttl || '',
                alamat: item.alamat || '',
                kelurahan: item.kelurahan || '',
                kecamatan: item.kecamatan || '',
                pekerjaan: item.pekerjaan || item.mustahik?.pekerjaan || '',
                email: item.email || '',
                ...
                status: item.status ? item.status.replace(/_/g, ' ') : 'Registrasi',
