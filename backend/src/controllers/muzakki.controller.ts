      ...
      const defaultMuzakkis = [
        {
          ...
          catatan: 'Donatur Rutin Zakat Maal',
          kategori: 'Perorangan',
          status: 'Aktif',
          created_at: '2026-05-11T03:34:59.790Z'
        },
        {
          id: 'muz-2',
          nrm: 'MZ-002',
          nama: 'Dewi Kusuma',
          nik: '3374021111110002',
          tempat_lahir: 'Demak',
          tanggal_lahir: '1990-07-25',
          jenis_kelamin: 'Wanita',
          pekerjaan: 'Wiraswasta',
          alamat: 'Jl. Imam Bonjol No. 3',
          handphone: '081311110002',
          email: 'dewi.kusuma@email.com',
          catatan: 'Donatur Sedekah',
          kategori: 'Perorangan',
          status: 'Aktif',
          created_at: '2026-05-13T07:18:15.398Z'
        }
      ];
